...
public interface RestyCommandConfig extends Updater<UpdateCommandConfig> {
    ...
    /**
     * Gets fallback df.open.restypass.servertest.entity.
     *
     * @return the fallback df.open.restypass.servertest.entity
     */
    ...
    /**
     * Sets fallback df.open.restypass.servertest.entity.
     *
     * @param fallbackBean the fallback df.open.restypass.servertest.entity
     */
